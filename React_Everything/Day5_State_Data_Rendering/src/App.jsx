...
const App = () => {
  ...
  return (
    <div>
      {/* <h1 className="text-[70px] bg-red-300">Hello...</h1>
      <h3 className="text-xl">Guys....</h3> */}

      <h1 className="text-6xl flex justify-center items-center text-red-600">
        How Data Rendering
      </h1>

      {/* Inside jsx, want to run javascript, then use curly brackets*/}
      {/* {
